...
export const fetchHistoricalData = async(tiker:string)=>{debugger

  const response = await instanceReal.get(`/v1/ohlcv/${tiker}/USD/history?period_id=1MIN&time_start=2021-03-08T14:57:00&time_end=2021-03-08T16:57:00`)
